...
public class Preferences extends PreferenceActivity implements
     ...
     * @return text size
     */
    static float getTextsize(final Context context) {
        final SharedPreferences p = PreferenceManager
                .getDefaultSharedPreferences(context);
    ...
    private static Preference.OnPreferenceClickListener getPreferenceLauncher(final Context context,
            final Intent intent) {
    ...
    private static void registerPreferenceLauncher(final Preference p, final Context context,
            final Intent intent) {
        if (p != null) {
